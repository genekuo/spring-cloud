...
# Sample usage:
#
#   HOST=localhost PORT=7000 ./test-all.sh
#
: ${HOST=localhost}
: ${PORT=8443}
: ${PROD_ID_REVS_RECS=2}
...
#  --data '{"grant_type":"password", "username":"yuchiung10@yahoo.com.tw", "password":"Genekuo123", "audience":"https://localhost:8443/product-composite", "scope":"openid email product:read product:write", "client_id":"BXaLl0UmUl04p761JCKJ0bcEEm87oYMs", "client_secret":"AjtUm6_r0cys0IJr6lb3mxAXQhbrvgjPyXqu3rZBW3EayKNHiWbWlXAkodtFngZ4"}' -s | jq -r .access_token)
...
#  --url 'https://dev-vb7vi3nb.auth0.com/oauth/token' \
#  --header 'content-type: application/json' \
#  --data '{"grant_type":"password", "username":"yuchiung10@yahoo.com.tw", "password":"Genekuo123", "audience":"https://localhost:8443/product-composite", "scope":"openid email product:read", "client_id":"BXaLl0UmUl04p761JCKJ0bcEEm87oYMs", "client_secret":"AjtUm6_r0cys0IJr6lb3mxAXQhbrvgjPyXqu3rZBW3EayKNHiWbWlXAkodtFngZ4"}' -s | jq -r .access_token)
